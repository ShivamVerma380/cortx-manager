...
CSM_USER_ROLES = [CSM_SUPER_USER_ROLE, CSM_MANAGE_ROLE, CSM_MONITOR_ROLE,CSM_TEST_ROLE]
...
# Query deployment
TOPOLOGY_RESOURCES = ['nodes', 'storage_sets', 'certificates']
TOPOLOGY = 'topology'
...
TOPOLOGY_NAME = 'TOPLOLOGY>name'
URL = 'url'
BACKEND = 'backend'
TOPOLOGY_DICT_INDEX = "topology_dict_index"
METADATA = 'metadata'
DIX = 'dix'
SNS = 'sns'
PARITY = 'parity'
